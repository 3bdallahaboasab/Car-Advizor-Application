...
import 'package:test/Presentation/menu/Screens/about_us_screen.dart';
import 'package:test/Presentation/menu/Screens/contact_us_screen.dart';
import 'package:test/Presentation/menu/Screens/my_store_screen.dart';
import 'package:test/Presentation/menu/Screens/privacy_police_screen.dart';
import 'package:test/Presentation/menu/Screens/terms_and_conditions.dart';
...
import 'package:test/Presentation/menu/Components/widget_profile_divider.dart';
import 'package:test/Presentation/menu/Components/widget_profile_list_tile.dart';
...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    selectLang =
        CacheHelper.getData(key: LANG_CACHE) == 'en' ? 'English' : 'العربية';
    return Scaffold(
      body: SafeArea(
        child: Stack(
